...
function App() {
  ...
  const timeFilteredTransactions = useMemo(() => {
    const now = new Date(); // Only used for 'today' and 'week' relative to REAL current time
    ...
    return transactions.filter(t => {
        ...
        if (timeRange === 'month') {
            // Filter based on the selected VIEW DATE, not necessarily "now"
            return tDate.getMonth() === viewDate.getMonth() && tDate.getFullYear() === viewDate.getFullYear();
        }

        return true;
    });
  }, [transactions, timeRange, viewDate]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center gap-3">
               ...
               <div className="flex items-center bg-slate-100 rounded-xl p-1 gap-1">
                   {timeRange === 'month' && (
                       <button onClick={prevMonth} className="p-1.5 hover:bg-white rounded-lg text-slate-500 hover:text-indigo-600 transition-colors">
                   ...
                   <div className="relative group min-w-[100px] text-center">
                      {timeRange === 'month' ? (
                          <span className="text-xs font-bold text-slate-800 uppercase px-2 cursor-pointer" onClick={() => {
                              // Optional: Reset to today if clicked
                      ...
                      <select 
                        ...
                        className={`appearance-none bg-transparent text-slate-700 text-sm font-semibold cursor-pointer outline-none w-full text-center ${timeRange === 'month' ? 'absolute inset-0 opacity-0' : 'block'}`}
                      >
                   ...
                   {timeRange === 'month' && (
                       <button onClick={nextMonth} className="p-1.5 hover:bg-white rounded-lg text-slate-500 hover:text-indigo-600 transition-colors">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-4 h-4">
          ...
          <div className="md:hidden pb-4">
              <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide items-center">
                  ...
                  {/* Mobile Date Nav (Only visible if month is selected) */}
                  {timeRange === 'month' && (
                      <div className="flex items-center gap-1 ml-auto bg-white border border-slate-200 rounded-lg px-1 py-0.5">
                           ...
                           <span className="text-[10px] font-bold uppercase text-slate-700 whitespace-nowrap">{monthDisplay}</span>
            ...
            <div className="px-6 py-5 border-b border-slate-100 flex flex-col sm:flex-row justify-between items-center bg-slate-50/50 gap-4">
              <div className="flex items-center gap-3">
                 <h3 className="font-bold text-slate-800 text-lg">
                    ...
                    {timeRange === 'month' && `Movimientos de ${monthDisplay}`}
                        ...
                        <td className="px-4 py-4 text-right relative z-10">
                            <div className="flex items-center justify-end gap-2">
                                ...
                                <button
                                    ...
                                    className="bg-indigo-50 text-indigo-500 hover:text-white hover:bg-indigo-600 transition-all p-2.5 rounded-lg shadow-sm border border-indigo-100 cursor-pointer active:scale-95"
                 ...
                 <div className="mb-8 p-4 bg-slate-50 border border-slate-200 rounded-xl">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <label className="flex flex-col items-center justify-center p-3 bg-white border border-slate-200 rounded-xl hover:bg-indigo-50 hover:border-indigo-200 hover:text-indigo-600 transition-all gap-1 cursor-pointer">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5m-13.5-9L12 3m0 0 4.5 4.5M12 3v13.5" />
                                <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v12m-9-3 9 3 9-3" className="hidden" />
